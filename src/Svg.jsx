export function DashboardSvg() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5A698F">
...
export function DotSvg() {
  return (
    <svg fill="#ffffff" width="10px" height="10px" viewBox="0 0 20.00 20.00" xmlns="http://www.w3.org/2000/svg" transform="rotate(0)">
...
export function BookmarkAddedSvg() {
  return (
